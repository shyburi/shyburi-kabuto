#!/usr/bin/env python3
"""フジテレビ・中居問題関連ニュースを全番組から取得してD1に格納（topic='fuji_tv'）"""
...
KEYWORDS = ['フジテレビ', '中居正広', '中居', 'フジ・メディア', 'フジメディア', 'フジＴＶ', '女性トラブル', '第三者委員会']
...
for a in all_articles:
    cmd = (f"INSERT OR IGNORE INTO scored_articles (id, program, headline, date, score_y, score_z, score_color, topic) "
           f"VALUES ('{a['id']}', '{a['program']}', '{a['headline']}', '{a['date']}', 0.0, 0.0, 0.0, 'fuji_tv');")
